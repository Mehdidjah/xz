...
#define assert_null(ptr) do { stest_assert_null(ptr, __func__, __LINE__); } while (0)
#define assert_not_null(ptr) do { stest_assert_not_null(ptr, __func__, __LINE__); } while (0)
#define assert_ptr_equal(expected, actual) do { stest_assert_ptr_equal(expected, actual, __func__, __LINE__); } while (0)
#define assert_ptr_not_equal(expected, actual) do { stest_assert_ptr_not_equal(expected, actual, __func__, __LINE__); } while (0)
